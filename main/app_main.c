...
// Define the sensor handle as a global variable
bme680_t sensor;
...
void bme680_init(void)
{
    ...
    ESP_ERROR_CHECK(bme680_init_desc(&sensor, BME680_I2C_ADDR_1, i2c_master_port, BME680_I2C_SDA_PIN, BME680_I2C_SCL_PIN));
    sensor.i2c_dev.cfg.scl_pullup_en = 1; // Enable internal pull-up for SDA
    sensor.i2c_dev.cfg.sda_pullup_en = 1; // Enable internal pull-up for SCL
